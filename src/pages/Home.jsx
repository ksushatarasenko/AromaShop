...
export default function Home() {
  ...
  const organizationSchema = {
    ...
    "@graph": [
      {
        "@type": "OnlineStore",
        "@id": "https://aroma.shop.pl/#organization",
        name: "AromaShop",
        alternateName: "Aroma Shop",
        url: "https://aroma.shop.pl",
        logo: "https://aroma.shop.pl/assets/brand/logo.png",
        description: t("site.description"),
      },
      {
        "@type": "WebSite",
        "@id": "https://aroma.shop.pl/#website",
        url: "https://aroma.shop.pl",
        name: "AromaShop",
        alternateName: "Aroma Shop",
        publisher: {
  ...
  const journal = articles.filter((a) => a.featured).slice(0, 6);
    ...
    <>
      ...
      <section className="section journal-section">
        <div className="container">
          ...
          <div ref={journalRef} className="journal-carousel">
            {journal.map((article) => (
              <div className="journal-carousel__item" key={article.id}>
